...
\end{align}
%
and ranges from zero for unpolarized light, to one for completely polarized light.  It is possible to show the polarized and unpolarized intensities as individual components
summed together as
%
\begin{align}
    S=S_P+S_U=
