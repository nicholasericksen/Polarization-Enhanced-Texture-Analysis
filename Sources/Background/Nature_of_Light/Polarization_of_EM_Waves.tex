...
\begin{figure}[!htb]
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.5]{/Sources/Background/Nature_of_Light/polarization-ellipse-binary.png}}
    \end{center}
...
\end{align}
%
the time averages are calculated as [TODO Fix this equation]
%
\begin{align}
