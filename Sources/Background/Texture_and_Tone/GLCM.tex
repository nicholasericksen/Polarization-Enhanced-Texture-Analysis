...
A single relationship Co-Occurance matrix is formulated such that,
%
\begin{align}
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Texture_and_Tone/glcm.png}}
\end{center}
%
