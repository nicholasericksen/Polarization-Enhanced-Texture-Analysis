...
\begin{sidewaysfigure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.375]{/Sources/Results/glcm/specular/V-filter-all-species-rgb.png}}
    \end{center}
...
\begin{sidewaysfigure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.4]{/Sources/Results/7_2_2/S1_polar_v2.png}}
    \end{center}
...
\begin{sidewaysfigure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.4]{/Sources/Results/7_2_2/S2_polar_v2.png}}
    \end{center}
...
\begin{sidewaysfigure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.375]{/Sources/Results/glcm/specular/0wk-1wk-P-filter-red-oak-rgb-specular.png}}
    \end{center}
...
\begin{sidewaysfigure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.4]{/Sources/Results/7_2_4/S1-polar-v2.png}}
    \end{center}
...
\begin{sidewaysfigure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.4]{/Sources/Results/7_2_4/S2_polar_v2.png}}
    \end{center}
...
\begin{sidewaysfigure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.375]{/Sources/Results/glcm/diffuse/V-filter-all-species-rgb-diffuse.png}}
    \end{center}
...
\begin{sidewaysfigure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.4]{/Sources/Results/7_2_5/S1-polar-v2.png}}
    \end{center}
...
\begin{sidewaysfigure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.4]{/Sources/Results/7_2_5/S2-polar_v2.png}}
    \end{center}
...
\begin{sidewaysfigure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.375]{/Sources/Results/glcm/diffuse/0wk-1wk-P-filter-red-oak-rgb-diffuse.png}}
    \end{center}
...
\begin{figure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.65]{/Sources/Results/rwc-regression.png}}
    \end{center}
...
\begin{figure}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[scale=0.65]{/Sources/Results/rwc-diffuse.png}}
    \end{center}
