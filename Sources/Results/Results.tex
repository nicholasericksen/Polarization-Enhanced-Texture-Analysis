...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{Sources/Background/Results/721/allhistpolarization.png}}
\end{center}
%
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/721/all_s2_polarization.png}}
\end{center}
%
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/721/all_glcm.png}}
\end{center}
%
...
%TODO add three Images
Close inspection Figure 22 and Figure 21 show that the new leaf is a darker green in color and has a smoother surface than the oak leaf after 1 week.  The smooth, thick wax surface becomes flatter and segmentation of structures on the leaf surface becomes more evident.
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_2/s1_polar.png}}
\end{center}
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_2/s2_polar.png}}
\end{center}
%
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_2/glcm_age_specular.png}}
\end{center}
%
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_3/confusion.png}}
\end{center}
%
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_3/learning_curve.png}}
\end{center}
%
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_4/s1-polar.png}}
\end{center}
%
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_4/S2-polar.png}}
\end{center}
%
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_4/glcm.png}}
\end{center}
%
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_5/s1-polar.png}}
\end{center}
%
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_5/s2-polar.png}}
\end{center}
%
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_5/glcm.png}}
\end{center}
%
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_6/confusion.png}}
\end{center}
%
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_2_6/learning_curve.png}}
\end{center}
%
%TODO add tables
...
%
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=8cm]{/Sources/Background/Results/7_3/linear-regression.png}}
\end{center}
%
...
%todo add table
The root mean squared shows the accuracy to be within 0.5% of the actual value for the predicted linear model.  The classifier was initialized with the parameters
%TODO add code
