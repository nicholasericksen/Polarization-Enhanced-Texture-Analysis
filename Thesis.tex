...
\newacronym     {VARI}{VARI}{Visible Atmospherically Resistant Index}
...
\subtitle{w
ith Applications to Precision Agriculture}
...
%    \newpage
    \include{Sources/Appendix/Appendix}
  \endgroup
